...
### Fixed
- Feat(lunar-lander): iPad touch controls and arcade SFX: Add subtle rotate/thrust touch UI, Web Audio rumble/thrust/crash with

## [1.53.0] - 2026-08-07

### Fixed
- Feat(lunar-lander): all pads landable with unlabeled 1X: Keep all 14 flats legal each round; only four show bonus multipliers,

## [1.52.0] - 2026-08-07

### Fixed
- Feat(lunar-lander): attract demo flight and clearer high scores: Add AI demo play behind the attract board, fix coin fuel after demo,

## [1.51.0] - 2026-08-07

### Fixed
- Feat(lunar-lander): random endgame lines and optional debug HUD: Add arcade message pools for safe/hard/crash outcomes, vector PAUSED

## [1.50.2] - 2026-08-07

### Fixed
- Fix(deadpool): improve seal visibility and post-reveal UX: Show fingerprints on Everyone's Lists, keep Sealed Lists in nav after

## [1.50.1] - 2026-08-07

### Fixed
- Fix(lunar-lander): stabilize approach zoom framing: Add altitude hysteresis, fit-based zoom caps, and single-pass camera

## [1.50.0] - 2026-08-07

### Added
- Add Lunar Lander at /lunar-lander with HIGH SCORES: Host the arcade game via public rewrite, persist top-10 scores in Supabase,

## [1.49.2] - 2026-07-30

### Fixed
- Chore(deadpool): use deceased figures in the pick-list placeholder: Keith Richards and Willie Nelson are live picks, so the example doubled

## [1.49.1] - 2026-07-30

### Fixed
- Fix(deadpool): gate post-reveal nav and clarify seal copy: Hide My Picks/Sealed Lists after a player reveals, show Everyone's Lists only then, and use January 1 of the season year in the Important notice.

## [1.49.0] - 2026-07-30

### Fixed
- Feat(deadpool): prefill registration email with next season year: Make the home-page mailto subject and body use the recruiting season so requests are easier to sort.
...
### Fixed
- Feat(deadpool): make Sign In the default entry point instead of Register: Returning participants are the common case and registering is the one-time
...
### Added
- Add agent dev foundation and remove VideoMaster: Add AGENTS.md, CLAUDE.md, SKILLS.md agent contract docs

### Fixed
- Docs(changelog): tighten 1.44.6 entry: Made-with: Cursor
...
### Fixed
- Fix(lease-minder): selection restore, form sync, and save UX: Persist last lease per user without clearing on mount; restore on load

## [1.43.0] - 2026-04-15

### Added
- LeaseMinder leases in Supabase, VideoMaster hub, release rule: Add LeaseMinder two-pane UI and migration; VideoMaster OFS pages; track

### Fixed
- Backgammon heuristic analysis factors reference: Made-with: Cursor

## [1.42.0] - 2026-04-15

### Fixed
- Correct opening roll statistics (15 valid rolls, not 21): Opening rolls cannot be doubles in backgammon, so only 15 rolls are valid:

## [1.41.0] - 2026-02-16

### Added
- World-class Heuristic Engine with strategic evaluation factors: Add three critical new factors to dramatically improve opening move analysis:

## [1.40.0] - 2026-02-16

### Added
- Add skill level presets and adaptive Monte Carlo engine: Major improvements to backgammon analysis:

## [1.39.2] - 2026-02-09

### Fixed
- Feat(play): fix broken XGID paste button

## [1.39.1] - 2026-02-09

### Fixed
- Correct ghost move coordinate conversion for multi-move sequences: Fix coordinate conversion bug where ghost moves showed wrong positions

## [1.39.0] - 2026-02-08

### Added
- Improve options drawer UI and remove simulation parameters button: Convert modal options dialog to sliding drawer from right side
