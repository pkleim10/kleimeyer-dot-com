...
import { generateThanksgivingChecklistPDF } from '@/utils/generateThanksgivingChecklistPDF'
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  Organize Thanksgiving tasks and contributors
                </p>
              </div>
              <div className="mt-4 sm:mt-0 sm:ml-4 flex flex-col sm:flex-row gap-3">
                {items.length > 0 && (
                  <button
                    onClick={() => generateThanksgivingChecklistPDF(items)}
                    className="w-full sm:w-auto inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-700 text-white rounded-lg hover:from-green-700 hover:to-emerald-800 text-sm font-semibold shadow-md hover:shadow-lg transition-all duration-200"
                  >
