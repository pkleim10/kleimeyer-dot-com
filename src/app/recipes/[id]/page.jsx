...
export default async function RecipePage(props) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <article className="bg-white dark:bg-slate-800 shadow rounded-lg overflow-hidden">        
        <div className="px-6 py-8">
          ...
          {recipe.categories && (
            <div className="flex gap-2 mb-6">
              <span
                className="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-300"
              >
          ...
          {recipe.description && (
            <p className="text-gray-600 dark:text-gray-400 mb-8">{recipe.description}</p>
          )}
