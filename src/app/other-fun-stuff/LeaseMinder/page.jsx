...
export default function LeaseMinderPage() {
  const { user } = useAuth()
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-4 sm:gap-6">
              ...
              <p className="text-gray-600 dark:text-gray-300 sm:max-w-xl sm:ml-auto sm:text-right text-sm sm:text-base leading-relaxed">
                Track each vehicle&apos;s lease allowance, enter your current odometer, and estimate projected mileage
                and overage at turn-in. Data is saved to your account (Supabase).
              </p>
            </div>
          </div>
