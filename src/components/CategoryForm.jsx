  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 divide-y divide-gray-200 dark:divide-slate-700 bg-white dark:bg-slate-800 p-6 rounded-lg shadow">
      ...
      <div className="space-y-8 divide-y divide-gray-200 dark:divide-slate-700">
        <div className="pt-8">
          <div>
            <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100">Category Information</h3>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Basic information about the category.</p>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            ...
            <div className="sm:col-span-6">
              ...
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Brief description of the category.</p>
            </div>
